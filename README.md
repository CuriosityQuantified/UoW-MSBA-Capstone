...
| **Week 4** | [`curriculum/week-04-observability.md`](./curriculum/week-04-observability.md) | Tracing, cost guards, Langfuse setup |
| **Weeks 5–10** | [`curriculum/weeks-05-10-coding.md`](./curriculum/weeks-05-10-coding.md) | Hands-on builds: tools, memory, routing, multi-agent, eval, deployment |
